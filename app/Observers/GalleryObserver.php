...
class GalleryObserver
{
    ...
    {
        if ($gallery->isDirty('file')) {
            if(Storage::disk('public')->exists($gallery->getOriginal('file'))){
                Storage::disk('public')->delete($gallery->getOriginal('file'));
            }
        }
    }
