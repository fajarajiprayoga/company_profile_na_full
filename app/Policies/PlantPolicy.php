...
class PlantPolicy
{
    ...
    {
        return $user->hasRole(['super-admin', 'hr']) && $user->can('view-plant');
    }
    ...
    {
        return $user->hasRole(['super-admin', 'hr']) && $user->can('create-plant');
    }
    ...
    {
        return $user->hasRole(['super-admin', 'hr']) && $user->can('update-plant');
    }
    ...
    {
        return $user->hasRole(['super-admin', 'hr']) && $user->can('delete-plant');
    }
