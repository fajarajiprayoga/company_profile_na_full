...
class ProductViewChartMonthly extends ChartWidget
{
    protected static ?string $heading = 'Chart Monthly';
    ...
    public function generate(){
        ...
        //         'date' => $data['date']->format('Y-m'),
        //     ];
        // });
        
        // $datas = collect($datas)->groupBy(function ($item) {
        ...
        $rows = collect($response->getRows())->map(function ($row) {
            ...
            return [
                ...
                'date' => \Carbon\Carbon::createFromFormat('Ymd', $dimensions[3]->getValue())->format('Y-m'),
