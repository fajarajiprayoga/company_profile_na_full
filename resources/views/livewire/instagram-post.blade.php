    ...
    <div id="home-instagram-post-wrapper" class="space-y-4">
        ...
        <div class="block lg:hidden">
            <div class="relative w-full" data-carousel="">
                ...
                <!-- Slider controls -->
                <button type="button" class="absolute -left-11 top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
                ...
                <button type="button" class="absolute -right-11 top-0 end-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-next>
                    <span class="inline-flex items-center justify-center w-6 h-6 bg-black">
                        <svg class="w-2 h-2 text-white rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
